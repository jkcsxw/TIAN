...
TIAN 是一款简单的安装工具，帮助**任何人**——即使完全不了解AI或软件——在Windows电脑上快速配置强大的AI助手。无论您是想提升日常工作效率，还是希望为自己的业务实现自动化，TIAN 都能轻松搞定。

您不需要了解"终端"、"Python"或"API"是什么。只要您会在Windows上安装软件，就能使用 TIAN。
...
### Step 1 — Download TIAN | 第一步 — 下载 TIAN
...
### Step 2 — Run the Setup Wizard | 第二步 — 运行安装向导
...
更多技能包可由社区添加，也可针对您的业务定制开发。

---

## Extending TIAN | 扩展 TIAN
